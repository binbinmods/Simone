...
namespace Simone
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Simone";
        public static string heroName = characterName;

        public static string subclassName = "Ambusher"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Simone, the Ambusher.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Simone",
                _contentFolder: "Simone",
